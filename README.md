About libcudla-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/libcudla-feedstock/blob/main/LICENSE.txt)

Home: https://developer.nvidia.com/cuda-toolkit

Package license: [LicenseRef-NVIDIA-End-User-License-Agreement](https://docs.nvidia.com/cuda/eula/index.html)

Summary: CUDA Deep Learning Accelerator(DLA)

Documentation: https://docs.nvidia.com/cuda/index.html

cuDLA is an extension of the CUDA programming model to encompass DLA work as well.
It provides familiar CUDA programming model to work with DLA, reduces SW complexity
(without need for EGLStreams) to interoperate between DLA – GPU for your inference pipelines.
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libcudla-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libcudla-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `libcudla` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
pixi add libcudla libcudla-dev
# for installing globally
pixi global install libcudla libcudla-dev
```
...
It is possible to list all of the versions of `libcudla` available on your platform:
...
```
pixi search libcudla --channel conda-forge
```
...
Updating libcudla-feedstock
===========================

If you would like to improve the libcudla recipe or build a new
...
Note that all branches in the conda-forge/libcudla-feedstock are
